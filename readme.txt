=== Mack's NASCAR News Feed ===
Contributors: mackbincroft
Donate link: http://www.jawer.org
Tags: racing, nascar, car racing, nascar news, nascar driver, nascar drivers, nascar results, nascar racing, f1 racing, f1, indy racing, motorsports, stock car, stock cars, stock car racing, daytona 500, indy 500
Requires at least: 2.2.1
Tested up to: 3.2.1
Stable tag: 0.5

Lists the Latest NASCAR News

== Description ==

Mack's NASCAR News Feed plugin incorporates an external RSS news feed into a cool looking Flash news feed. The feed moves from bottom to top, with a nice NASCAR graphic, followed by headlines and stories. You can click on a story title or summary to see the actual page where it is posted. You can also edit the width and height of the plugin to suit your needs. Finally, you can select how many articles you want to appear in the feed: 1 to 10.

Relevant Keywords: cars, autos, racing, car racing, auto racing, stock car, stock cars, stock car racing, motorsports, NASCAR, NASCAR racing, NASCAR news, NASCAR results, NASCAR drivers, NASCAR races
...
1. Upload `macks-nascar-news-feeed` folder to the `/wp-content/plugins/` directory.
2. Go to you plugins' control panel and then click "Activate" to turn the plugin on.
3. Then, visit your "settings" control panel (on the lower left hand side of your blog for WP versions 2.9+ ) where you will see a link for "Mack's NASCAR News Feed". Click this link and then edit the settings as you like them.
...
Visit your Settings menu and click "Mack's NASCAR News Feed", and then edit the size and width to your requirements.
